...
def main():
    ...
    param_grid = {
        'kernel': ['rbf'],  # RBF performed best
        'C': [50, 75, 100, 125, 150],  # Fine-tune around 100
        'gamma': ['scale', 0.01, 0.05, 0.1],  # Fine-tune around scale
        'class_weight': ['balanced'],  # Balanced performed best
        'degree': [2, 3]  # Additional parameter for polynomial terms
    }
