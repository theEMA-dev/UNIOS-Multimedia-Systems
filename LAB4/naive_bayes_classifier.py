...
def main():
    # Configuration
    JSON_PATH = "d:/Dev/UNIOS-Multimedia-Systems/LAB4/audio_features.json"
    
    # Load and process data
    X, y, mappings = load_and_process_features(JSON_PATH)
    ...
    genre_counts = pd.Series(y).value_counts().sort_index()
    ...
    with open("LAB4/naive_bayes_results.txt", "w") as f:
    ...
    conf_df.to_csv("LAB4/confusion_matrix.csv")
